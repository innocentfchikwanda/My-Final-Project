...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="chore_control_view.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Assign</a>
        ...
        <div class="content">
            ...
            <!-- Manage Chores Main Section-->
            <div class="container-fluid pt-4 px-4">
                <div class="row vh-100 bg-secondary rounded align-items-center justify-content-center mx-0">
                    <div class="col-md-6 text-center">
                        <div class="col-12">
                            <div class="bg-secondary rounded h-100 p-4">
                                <h5 class="mb-4">Task Tracker</h5>
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Pending</td>
                                                <td><a class="btn btn-sm btn-primary" href="addTask.html">Detail</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><input class="form-check-input" type="checkbox"></td>
                                    ...
                                    <button type="button" class="btn btn-success m-2">Manage</button>
                                </div>
                            </div>
                        </div>
                    </div>
